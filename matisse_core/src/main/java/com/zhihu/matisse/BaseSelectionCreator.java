...
public abstract class BaseSelectionCreator {
   protected final BaseMatisse mMatisse;
    protected final SelectionSpec mSelectionSpec;
     ...
     */
    BaseSelectionCreator(BaseMatisse matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     * @see SelectionSpec#onlyShowImages()
     * @see SelectionSpec#onlyShowVideos()
     */
    public BaseSelectionCreator showSingleMediaType(boolean showSingleMediaType) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator theme(@StyleRes int themeId) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator countable(boolean countable) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator maxSelectable(int maxSelectable) {
        if (maxSelectable < 1)
     ...
     * @return  {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator maxSelectablePerMediaType(int maxImageSelectable, int maxVideoSelectable) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator addFilter(@NonNull Filter filter) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator capture(boolean enable) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator originalEnable(boolean enable) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator autoHideToolbarOnSingleTap(boolean enable) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator maxOriginalSize(int size) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator captureStrategy(CaptureStrategy captureStrategy) {
     ...
     */
    public BaseSelectionCreator restrictOrientation(@ScreenOrientation int orientation) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator spanCount(int spanCount) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator gridExpectedSize(int size) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator thumbnailScale(float scale) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator imageEngine(ImageEngine imageEngine) {
     ...
     * <p>
     * It's a redundant API with {@link BaseMatisse#obtainResult(Intent)},
     ...
     */
    @NonNull
    public BaseSelectionCreator setOnSelectedListener(@Nullable OnSelectedListener listener) {
     ...
     * @return {@link BaseSelectionCreator} for fluent API.
     */
    public BaseSelectionCreator setOnCheckedListener(@Nullable OnCheckedListener listener) {
    ...
    public BaseSelectionCreator showPreview(boolean showPreview) {
