...
public abstract class BaseMatisse {
    ...
    protected final WeakReference<Activity> mContext;
    protected  final WeakReference<Fragment> mFragment;

    protected  BaseMatisse(Activity activity) {
        this(activity, null);
    }

    protected  BaseMatisse(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    protected  BaseMatisse(Activity activity, Fragment fragment) {
     ...
     */
    public abstract BaseSelectionCreator choose(Set<MimeType> mimeTypes);
     ...
     * @see BaseSelectionCreator
     */
    public abstract BaseSelectionCreator choose(Set<MimeType> mimeTypes, boolean mediaTypeExclusive)  ;
